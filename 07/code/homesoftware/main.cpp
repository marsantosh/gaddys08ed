...
/**
 *                      displayMenu
 * This functions displays the user's menu on the screen.
 */
void displayMenu() {
    cout << "\n\n                MENU\n\n";
 ...
 * The user is prompted for the dollar amount of the depotsit,
 * and the makeDeposit member of the Account object is then called.
 */
...
void withdraw(Account &account) {
    ...
    cout << "Enter the amount og the withdrawal: ";
    cin >> dollars;
    cin.ignore();

...
int main() {
    ...
    cout << "The letter d appears " << frequency('d', inputString, 0) << " time(s)." << endl;
    return 0;
}
...
/*
 * frequency <- function
 * this recursive function counts the number of times the
 * character ch appears in inputString. The search begins
